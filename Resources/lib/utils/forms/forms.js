...
keyboardMap[exports.TYPE_TEXTAREA] = Ti.UI.KEYBOARD_DEFAULT;
...
var addField = function(field, fieldRefs) {
	...
	if (type === exports.TYPE_TEXT ||
		...
		fieldObject = Ti.UI.createTextArea(textAreaDefaults);
		fieldObject.keyboardType = keyboardMap[type];
		...
		// This forces text areas to always have a label-on-top style
		...
		// TODO iOS doesn't automatically have text with the switch!
		var checkbox;
		if (isAndroid) {
